...
import { Card, Table, Button, Modal, Form, Badge, FormControl, Navbar, Offcanvas, InputGroup } from 'react-bootstrap';
...
const Parts = () => {
    ...
    // current_stock diset default 0 di background agar database tidak error, tapi tidak ditampilkan di UI
    ...
    // STATE MODAL KONFIRMASI HAPUS GG WP
    const [deleteModal, setDeleteModal] = useState({ show: false, item: null });

    // STATE SCANNER KAMERA DI FORM PART
    ...
    // LOGIKA LIFECYCLE KAMERA SCANNER PART
    useEffect(() => {
        let scanner = null;
        if (isPartCameraOpen) {
            ...
            <Modal show={show} onHide={handleClose} centered>
                ...
                <Form onSubmit={handleSave}>
                    <Modal.Body className="small">
                        ...
                        {/* TOMBOL DAN SCANNER KAMERA UNTUK PART NUMBER */}
                        <Form.Group className="mb-3">
                        ...
                        {/* MODIFIKASI: Kolom Initial Stock Dihilangkan */}
                        <Form.Group className="mb-3">
